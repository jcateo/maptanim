//#region node_modules/leaflet-draw/dist/leaflet.draw.js
(function(t, e, i) {
	function o(t, e) {
	...
	L.drawVersion = "1.0.4", L.Draw = {}, L.drawLocal = {
		...
		_calculateFinishDistance: function(t) {
			...
			if (this._markers.length > 0) {
				...
				if (this.type === L.Draw.Polyline.TYPE) i = this._markers[this._markers.length - 1];
					...
					if (this.type !== L.Draw.Polygon.TYPE) return Infinity;
					i = this._markers[0];
				}
		...
		_onMarkerDrag: function(t) {
			...
			e._middleLeft && e._middleLeft.setLatLng(this._getMiddleLatLng(e._prev, e)), e._middleRight && e._middleRight.setLatLng(this._getMiddleLatLng(e, e._next)), this._poly._bounds._southWest = L.latLng(Infinity, Infinity), this._poly._bounds._northEast = L.latLng(-Infinity, -Infinity);
		...
		_onMarkerDragStart: function(t) {
			...
			var e = this._getCorners(), o = t.target._cornerIndex;
		...
		_move: function(t) {
			for (var e, i = this._shape._defaultShape ? this._shape._defaultShape() : this._shape.getLatLngs(), a = this._shape.getBounds().getCenter(), n = [], s = 0, r = i.length; s < r; s++) e = [i[s].lat - a.lat, i[s].lng - a.lng], n.push([t.lat + e[0], t.lng + e[1]]);
		...
		_onTouchStart: function(t) {
			if (this._map._loaded) this._touchEvent(t, "touchstart");
		},
		_onTouchEnd: function(t) {
			if (this._map._loaded) this._touchEvent(t, "touchend");
		},
		...
		_onTouchLeave: function(t) {
			if (this._map._loaded) this._touchEvent(t, "touchleave");
		},
		_onTouchMove: function(t) {
			if (this._map._loaded) this._touchEvent(t, "touchmove");
		},
		_detectIE: function() {
			...
			readableDistance: function(e, i, o, a, n) {
				...
				switch (i ? "string" == typeof i ? i : "metric" : o ? "feet" : a ? "nauticalMile" : "yards") {
					...
					case "nauticalMile":
						...
						break;
					default: e *= 1.09361, s = e > 1760 ? L.GeometryUtil.formattedNumber(e / 1760, n.mi) + " miles" : L.GeometryUtil.formattedNumber(e, n.yd) + " yd";
				}
				return s;
			},
		...
		_checkDisabled: function() {
			var t, i = 0 !== this.options.featureGroup.getLayers().length;
